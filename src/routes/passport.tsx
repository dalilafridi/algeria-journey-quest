    ...
    <div className="min-h-dvh bg-background">
      ...
      <main className="max-w-5xl mx-auto px-3 sm:px-6 py-6 sm:py-10">
        ...
        <div className="no-print mb-5 flex flex-wrap items-center justify-between gap-3">
          <div>
            <p className="text-[11px] uppercase tracking-[0.28em] text-amber-200/60" style={{ fontFamily: SERIF }}>
              DZ Odyssey · Museum of Memory
            </p>
            <h1 className="text-2xl sm:text-3xl font-semibold text-amber-100" style={{ fontFamily: SERIF }}>
              {tri(lang, TXT.title)}
            </h1>
          </div>
          <div className="flex items-center gap-2">
            <button
              onClick={startEdit}
              className="rounded-full border border-amber-300/30 bg-transparent px-4 py-2 text-sm font-medium text-amber-100 hover:bg-amber-300/10 transition"
            >
